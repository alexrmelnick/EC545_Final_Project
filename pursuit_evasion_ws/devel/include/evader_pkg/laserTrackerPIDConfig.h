...
namespace yahboomcar_laser
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(laserTrackerPIDConfig &config, const laserTrackerPIDConfig &max, const laserTrackerPIDConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const laserTrackerPIDConfig &config1, const laserTrackerPIDConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, laserTrackerPIDConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const laserTrackerPIDConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, laserTrackerPIDConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const laserTrackerPIDConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const laserTrackerPIDConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, laserTrackerPIDConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
